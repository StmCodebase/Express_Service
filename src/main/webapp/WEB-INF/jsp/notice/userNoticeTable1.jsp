...
<div id="page">
		...
		<div class="page-inner">
			...
			<div class="row" style="margin-top: 0px;">
                   <div class="col-md-8 col-lg-offset-2" style="background-color: white;height:350px ;"><!--原 height:100%  -->
	<div class="row text-center" style="margin: 80px 80px;" height="600px">
		<div class="text-center"  >
			<table frame="void" rules="none">
					  			<c:forEach items="${pageInfo.list}" var="notices">
					  				<tr>						  				
						  				<td width="600px" align="left" style="font-size:35px"><a href="${pageContext.request.contextPath}/notice/userNoticeText?noticeNo=${notices.noticeNo}">${notices.noticeTitle}</a></td>
