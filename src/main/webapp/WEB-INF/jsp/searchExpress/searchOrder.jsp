  ...
  <link href="https://fonts.googleapis.com/css?family=Roboto:300,400,700" rel="stylesheet">
	...
	<link rel="stylesheet" href="${pageContext.request.contextPath}/plug/css/noticeCss/style.css">
		...
		<div id="page">
			...
			<div class="page-inner">
				...
				<header id="gtco-header" class="gtco-cover gtco-cover-sm" role="banner" style="background-image: url(${pageContext.request.contextPath}/plug/img/searchImg/bg4.jpg)">
							...
							<div class="col-md-12 col-md-offset-0 text-left">
								...
								<div class="row row-mt-15em">
									...
									<div class="col-md-7 mt-text animate-box" data-animate-effect="fadeInUp">
										...
										<h1>运单号查快递</h1>
										<h1>Order Number Check Express</h1>
									</div>
        ...
        <span class="icon-bar"></span>
								...
								<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
									<ul class="nav navbar-nav">
										...
										<li >
											<a href="${pageContext.request.contextPath}/post/searchNumber"><span class="glyphicon glyphicon-phone" aria-hidden="true"></span>&nbsp;手机号查询</a>
										</li>
					...
					<div class="text-center"  style=" margin-top: 80px; ">
						...
						<div class="row ">
							<div class="col-xs-8 col-md-offset-1">
								<input type="text" class="form-control input-lg "  placeholder="请输入订单号进行查询" id="poNo" name="poNo">
							</div>
							<div class="col-xs-2">
                ...
                <div class="bottom-tu">
					<div class="pics">
						<img src="${pageContext.request.contextPath}/plug/img/searchImg/ad3.jpg" alt="" class="pic1">
						<img src="${pageContext.request.contextPath}/plug/img/searchImg/ad4.jpg" alt="" class="pic2">
					</div>
				</div>
	...
	<script>	
		...
		function doAjaxPost(){
			...
			$.ajax({
	        	type : "POST",
	        	url  : "${pageContext.request.contextPath}/post/queryExpressBypoNo",
	        	//async: false,
	        	data : {
	        		"poNo" : poNo
	        	},
	        	...
	        	success : function(result) {
	        		...
	        		if (resObj.result) {
	                    ...
	                    layer.msg("订单号不正确，请重新输入", {time:2000, icon:5, shift:6}, function(){
