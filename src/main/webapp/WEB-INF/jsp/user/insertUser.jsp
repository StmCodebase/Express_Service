...
<div align="center" style="padding-top: 50px;">
	<form action="${pageContext.request.contextPath}/user/add" method="post" accept-charset="utf-8" onsubmit="return doPost()">
		<table class="table table-bordered table-striped" style="width: 500px;">				
			...
			<tr>
				<td colspan="2" class="text-center">
					<input class="form-control" type="hidden" id="gNo" name="gNo" value="1">
